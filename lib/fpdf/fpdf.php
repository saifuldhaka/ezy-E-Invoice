...
{
	// Fatal error
	throw new Exception('FPDF error: '.$msg); // phpcs:ignore WordPress.Security.EscapeOutput.ExceptionNotEscaped
}
...
{
	$date = @gmdate('YmdHisO',$this->CreationDate); // phpcs:ignore WordPress.DateTime.RestrictedFunctions.date_date
